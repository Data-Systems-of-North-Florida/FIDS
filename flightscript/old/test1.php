...
# Displays it formated on an output HTML Page.                 #
#                                                              #
#          Written by:                                         #
#                       Eric Pine                              # 
...
$outputfile="/home/gragnv/flightawarescript/test1.html";
$addtotime=60*60 #to correct system time
...
foreach ($result->arrivals as $value) {
        ...
        #only display arrivals in the last 6 hours
             ...
             if ($airline=="US Airways Express"){echo "2";}
             echo $fltnum;
...
<?php echo date("g:i A m/d/y", Time()+$addtotime); ?>
<br/>Disclaimer: Flight information is subject to change - Please check with the airline to verify flight information</div>
</div>         
</div>
<div class="accessFooter" align=left><font size="+2" face="arial black" color=navy><i>DSI</i></font> <p>Flight information is derived from FlightAware</a> data.  For any questions, please contact Data Systems of North Florida regarding the Flight Tracker</a>.</p></div>
<script>delayedRedirect(300*1000, 'http://www.gra-gnv.com/flightaware');</script>
...
file_put_contents($outputfile,$out1);
ob_end_clean();
