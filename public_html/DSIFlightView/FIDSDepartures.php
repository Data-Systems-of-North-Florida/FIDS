...
<html>
    ...
    <body onload="Clock()">
        <div class="fidsMain" style="width:100%">
        <div class="fidsLogo"><img src="Gainesville_Logo_3.jpg"></div>         
        <div class="fidsPrimary" style="width:100%">
        <h1 class="fidsTitle">Departures <span id=clock></span></h1>
                <div class="ffResult">
                <center>
                      <div class="ffResultList" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:msxml="urn:schemas-microsoft-com:xslt">
        <div class="header">
        <table cellspacing="0" border="0" cellpadding="0" bgcolor=lightblue>
        <tr>
        <th class="column1" style="width:6%">Airline</th>
        <th class="column2" style="width:3%">Flight#</th>
        <th class="column4" style="width:4%">Dest.</th>
        <th class="column6" style="width:3%">Time</th>
        <th class="column3" style="width:6%">Status</th>
        </tr>
        </table>
        </div>
        <div class="data">
...
$objDOM1->load("/home/gragnv/public_html/DSIFlightView/departures.xml"); 
